...
import GastoLineaPage from "@/components/gastoLinea";
import TargetaMesPage from "@/components/targetaMes";
import { Targetas } from "@prisma/client";
import { useAppSelector } from "@/store";
import ListGastosPage from "@/components/gastos/listGastos";
  ...
  return (
    <div>
      <div className="flex items-center">
        <span className="text-5xl">{targeta?.nombre}  </span>
        <span className="text-4xl">  {mesActual}</span>
        ...
        <table className="table-auto w-full border-collapse border border-gray-300">
          ...
          <tbody>
            {
              <ListGastosPage gastosC={targeta?.gastosC!} targeta={targeta?.nombre}/>
            }
          </tbody>
        </table>
